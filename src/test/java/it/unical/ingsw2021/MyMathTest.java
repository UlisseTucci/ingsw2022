...
public class MyMathTest {
	...
	@Mock
	private ConnectionManager connectionManagerMock; // Oggetto finto creato con 'org.mockito'
	@Rule
	public MockitoRule mockitoRule = MockitoJUnit.rule(); // Impostazione della libreria 'org.mockito'
	
	@BeforeClass
	public static void prepareAll() {
		System.out.println("Before class");
		/* myMath = new MyMath(); // Creiamo un oggetto statico qui il quale può essere utilizzato in tutti
		gli altri casi di prova che seguiranno. */
	}
	...
	public void remoteFactorialWorks() {
		...
		when(connectionManagerMock.isNetworkConnected()).thenReturn(true); // Obblighiamo la funzione a restituirci 'true'
	...
	public void remoteFactorialThrowsException() {
		...
		when(connectionManagerMock.isNetworkConnected()).thenReturn(false); // Obblighiamo la funzione a restituirci 'false'
